 ...
 <?php
	...
	if (isset($_POST['submit'])) {
		...
		$statement = $db_con->prepare("UPDATE `users` SET `firstname` = '$firsname', `lastname` = '$lastname', `mobile` = '$mobileno', `username` = '$username'  WHERE `users`.`email` = '$email';");
		$statement->execute();
	}

	$res = showdetails($_SESSION['email']);
	?>
 <!-- begin:: Subheader -->
 					...
 					<div class="kt-widget kt-widget--user-profile-1">
 						<div class="kt-widget__head">
 							<div class="kt-widget__media">
 								<img src="<?php echo $siteurl; ?>/assets/media/users/100_1.jpg" alt="image">
 							</div>
 							...
 							<div class="kt-portlet__body">
 								<div class="kt-section kt-section--first">
 									...
 									<div class="form-group row">
 										...
 										<div class="col-lg-9 col-xl-6">
 											<div class="input-group">
 												...
 												<input type="text" class="form-control" name="mobile" value=<?php echo $res['mobile'] ?> placeholder="Phone" aria-describedby="basic-addon1" required>
 											</div>
 									...
 									<div class="form-group row">
 										...
 										<div class="col-lg-9 col-xl-6">
 											<div class="input-group">
 												...
 												<input type="text" class="form-control" name="email" value=<?php echo $res['email'] ?> placeholder="Email" aria-describedby="basic-addon1">
 											</div>
 										</div>
 									</div>
 									<div class="form-group form-group-last row">
 										...
 										<div class="col-lg-9 col-xl-6">
 											<div class="input-group">
 												<input type="text" name="username" class="form-control" placeholder="Username" value=<?php echo $res['username'] ?> required>
