...
if (isset($_POST['submit'])) {
	...
	if ($newpass == $verifypass) {
		$true = checkpassword($email, $currentpass, $newpass);
		if ($true == true) { ?>
			<script> 
				alert('Password updated!!');
				window.open('http://localhost/Event/demo1/custom/apps/user/profile-1/change-password.php');
			</script> <?php 
									...
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-xl-6">
													<input name="currentpass" type="password" class="form-control" value="" placeholder="Current password">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-xl-6">
													<input name="newpass" type="password" class="form-control" value="" placeholder="New password">
												</div>
											</div>
											<div class="form-group form-group-last row">
												<label class="col-xl-3 col-lg-3 col-form-label">Verify Password</label>
												<div class="col-lg-9 col-xl-6">
													<input name="verifypass" type="password" class="form-control" value="" placeholder="Verify password">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="kt-form__actions">
										<div class="row">
											...
											<div class="col-lg-9 col-xl-9">
												<input type="submit" class="btn btn-brand btn-bold" name="submit" value="change password">&nbsp;
